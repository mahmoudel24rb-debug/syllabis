...
const metrics = [
  ...
  { value: "5 à 15%+", label: "de FOAD", desc: "Part de formation à distance dans les parcours, levier direct sur les marges" },
];
        ...
        <div className="mx-auto max-w-container px-4 sm:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              {
                step: "1",
                title: "Chargez votre référentiel",
        ...
        <div className="mx-auto max-w-container px-4 md:px-8">
          <div className="flex flex-col justify-center text-center">
            ...
            <p className="mt-4 text-lg text-tertiary md:mt-5 md:text-xl">
              Chargez votre référentiel, laissez l&apos;IA structurer le contenu, exportez en SCORM. Testez gratuitement.
            </p>
