...
const problems = [
  ...
  "API exhaustive pour integrer dans votre stack",
...
const features = [
  {
    title: "Multi-tenant",
    description:
      "Architecture multi-tenant native avec isolation des donnees, gestion des quotas et cost tracking par organisation.",
  },
  {
    title: "API 227+ routes",
    description:
      "API REST complete avec 227+ endpoints documentes. Integrez Syllabis dans votre produit existant.",
  },
  {
    title: "Branding custom",
    description:
      "Personnalisez les couleurs, logos et domaines pour chaque client. Experience white-label complete.",
  },
  {
    title: "Organisations multiples",
    description:
      "Gerez plusieurs organisations avec 5 roles, branch access et permissions granulaires.",
  },
];
...
export default function EdtechPage() {
  return (
    <>
        ...
        <div className="relative mx-auto max-w-container px-4 sm:px-8 pt-16 sm:pt-24 pb-16 sm:pb-20">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mt-6 text-lg sm:text-xl text-neutral-600 max-w-2xl mx-auto">
              Proposez du contenu e-learning a vos clients
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-container px-4 sm:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-display-sm sm:text-display-md font-semibold text-neutral-900">
              Une plateforme multi-tenant prete a integrer
            </h2>
      ...
      {/* ── CTA ── */}
      <CTABanner
        title="Discutons de votre integration"
        description="Decouvrez comment Syllabis peut s'integrer dans votre produit via notre API."
